package com.example.examplemod.mc_15_tobisuke;// Made with Blockbench 4.6.4
...
public class ModelOriginalTobisuke<T extends Entity> extends EntityModel<T> {
	...
	public static LayerDefinition createLayer() {
		...
		PartDefinition arm_L = partdefinition.addOrReplaceChild("arm_L", CubeListBuilder.create().texOffs(16, 22).addBox(4.5F, -5.0F, -7.0F, 1.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));

		PartDefinition arm_R = partdefinition.addOrReplaceChild("arm_R", CubeListBuilder.create().texOffs(26, 18).addBox(-5.5F, -5.0F, -7.0F, 1.0F, 4.0F, 8.0F, new CubeDeformation(0.0F)), PartPose.offset(0.0F, 24.0F, 0.0F));
